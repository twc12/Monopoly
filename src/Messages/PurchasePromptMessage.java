...
/**
 * This Class will be a message sent from the model to the view
 * to create a purchase "prompt" where the player can accept/skip buying
 * @author Jake
 */
public class PurchasePromptMessage {
	...
	/**
	 * Constructor, pass in the player doing the buying, and the property
	 * @param currentPlayer
	 * @param property
	 */
